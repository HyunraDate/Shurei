...
//In this way: const geometry = new THREE.BufferGeometry().setFromPoints(points)
//also can use downpon

const n = 100
const points = new Float32Array( n * 3) //*3因为一个点有三个坐标
//This is a Array 32位
for( let i = 0; i < n; i++){
    let x = (Math.random() - 0.5) * 4 //每次随机生成三个数
...
// 点，线，面（体）//Line & Mesh 需要用Points连接起来
