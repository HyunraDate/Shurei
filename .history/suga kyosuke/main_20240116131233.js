...
const geometry = new THREE.BoxGeometry(1, 1, 1) //立方体， SphereGeometry(1) is 球
const material = new THREE.MeshBasicMaterial({color:'rgb(238,212,255)'}) //全部面都是这个颜色

const cube1 = new THREE.Mesh(geometry, material)
scene.add(cube1)
cube1.position.y= 1.5

const geometry2 = new THREE.BoxGeometry(1, 1, 1) //立方体， SphereGeometry(1) is 球
const material2 = new THREE.MeshBasicMaterial({color:'rgb(238,212,255)'}) //全部面都是这个颜色

const cube2 = new THREE.Mesh(geometry2, material2)
scene.add(cube2)

const geometry3 = new THREE.BoxGeometry(1, 1, 1) //立方体， SphereGeometry(1) is 球
const material3 = new THREE.MeshBasicMaterial({color:'rgb(238,212,255)'}) //全部面都是这个颜色
