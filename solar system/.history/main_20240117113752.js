...
//Objects 点线面 Geometry Basic ==============================
const geometry4 = new THREE.BoxGeometry(1, 1, 1, 10, 10, 10) 
//here 6 位数是 witdh, height, depth, weithSegments, heightSegments, depthSegments
//Segmentsy分段数越多，d.h.三角形越多，形状更光滑。 1 PI = 一半
//doc:
//BoxGeometry(width : Float, height : Float, depth : Float, 
//widthSegments : Integer, heightSegments : Integer, depthSegments : Integer
const material4 = new THREE.MeshNormalMaterial({
    wireframe: true // wireframe是线框， 默认是不设置-> falsch
    //color:'rgb(238,212,255)' ////eed4ff MeshNormalMaterial 发现就不用设置颜色了
}) 
...
const geometry5 = new THREE.SphereGeometry(0.5) //this is 半径
...
//平面
const planeGeometry = new THREE.PlaneGeometry(4, 4) //only w & h
const planeMaterial = new THREE.MeshBasicMaterial({
    color:'rgb(255,255,227)' //#FFFFE3
    //wireframe: true
})
const plane = new THREE.Mesh(planeGeometry, planeMaterial)
plane.rotation.x = -0.5 * Math.PI //默认 x,y 平铺在背面，here 旋转到地面
plane.position.y = -2
scene.add(plane)
console.log(plane)
