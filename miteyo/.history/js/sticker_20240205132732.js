...
import MontBlanc2 from '../img/MontBlanc2.jpg'
...
const texture2 = loader.load('../img/cream.jpg')
//https://threejs.org/manual/resources/images/compressed-but-large-wood-texture.jpg wood desk
const texture3 = loader.load(MontBlanc2) // another way to use picture

const m1 = new THREE.MeshStandardMaterial({
    map: loader.load('../img/MontBlanc1.jpg')
})

const m2 = new THREE.MeshStandardMaterial({
    map: loader.load('../img/MontBlanc2.jpg')
})

const m3 = new THREE.MeshStandardMaterial({
    map: loader.load('../img/MontBlanc3.jpg')
})

const m4 = new THREE.MeshStandardMaterial({
    map: loader.load('../img/MontBlancPink1.jpg')
})

const m5 = new THREE.MeshStandardMaterial({
    map: loader.load('../img/MontBlancPink2.jpg')
})

const m6 = new THREE.MeshStandardMaterial({
    map: loader.load('../img/MontBlancPink4.jpg')
})
// const texture4 = loader.load(t22)
// const texture5 = loader.load(t6464)

//this is about texure repeat
// texture4.magFilter = THREE.NearestFilter
// texture4.wrapS = THREE.RepeatWrapping
// texture4.wrapT = THREE.RepeatWrapping
// texture4.repeat.set(20, 20) //20个repeat: 同样画布大小 repeat越多，越清晰
...
const cube = new THREE.Mesh(cubeG, [m1, m2, m3, m4, m5, m6]) //cubeM change to m123456
cube.position.y = 0.5
...
const planeM = new THREE.MeshStandardMaterial({ //if you want shadow you need MeshStanderMaterial
